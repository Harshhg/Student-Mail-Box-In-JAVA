...
<div class="wrap">
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current"><a href="groupsentmail.jsp" class="m4">Group Sent</a></li>
  ...
  <div class="container">
    <aside>
        <div><marquee behavior="alternate"><h3 style="color:green">
                   <% out.print(name); %> 
...
<%
   ...
   Connection con= DriverManager.getConnection("jdbc:odbc:mydsn");  
  java.sql.Statement st=  con.createStatement();  
  String query = "SELECT * from email where sender = '"+user+"' and groupmail = '1' ";
